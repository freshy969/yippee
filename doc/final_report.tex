...
Given the critique of the centralized nature of Mercator's URLFrontier \cite{ubi, para}, we made our frontier pluggable via a factory pattern to allow us to easily test frontiers with varying degrees of politeness and implementations.
