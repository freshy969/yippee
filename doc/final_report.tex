...
Other features we will also implement is a way to update Hit objects when a document is recrawled and the contents have changed and also the ability to add more nodes/remove nodes on the fly. 
