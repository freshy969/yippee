...
versions, analyse the performance and optimize .

The architecture of the Search Engine is shown in figure 1. Our crawler follows the mercator design\cite{mercator}; however, since the design is criticized for its centralized URLFrontier \cite{ubi,para}, we made this component pluggable, so we can easily plug in and out different versions. We are confident that this design choice will greatly affect the crawler performance.
...
\begin{thebibliography}{9}
  ...
  \bibitem{google} Sergey Brin and Lawrence Page \emph{The Anatomy of a Large-Scale Hypertextual
Web Search Engine}, Stanford University, 1999
  ...
  \bibitem{para} Paolo Boldi, Bruno Codenotti, Massimo Santini, Sebastiano Vigna, \emph{UbiCrawler: a scalable fully distributed Web crawler}, Software: Practice and Experience 34 (2004), 711-726.
